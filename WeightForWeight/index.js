...
https://www.codewars.com/kata/55c6126177c9441a570000cc/train/javascript
    ...
    John is worried because each month a list with the weights of members is published and each month he 
    ...
    return string
        ...
        .map(x =>
            Object.assign(
                ...
                {
                    weight: x,
                    weightWeight: x.split("").reduce((acc, cur) => +acc + +cur, 0),
                }
            )
        )
        .sort((a, b) => {
            if (a.weightWeight === b.weightWeight) {
                if (a.weight < b.weight) return 1;
                if (a.weight > b.weight) return -1;
                return 0;
            }

            if (a.weightWeight < b.weightWeight) return -1;
            if (a.weightWeight > b.weightWeight) return 1;
            return 0;
        })
        .map(x => x.weight)
